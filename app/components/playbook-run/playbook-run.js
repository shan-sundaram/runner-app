define(['knockout', 'text!./playbook-run.html', '/scripts/fixtures.js'], function (ko, htmlString, fixtures) {
    ...
    function PlaybookRunViewModel(params) {
        var self = this;
    ...
    return {
        viewModel: PlaybookRunViewModel,
        template: htmlString
    };
});
